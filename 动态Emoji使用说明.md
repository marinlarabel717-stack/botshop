...
[emoji:5368324170671202286:📱:primary]商品列表
[emoji:5368324170671202287:🫥:danger]删除商品
```
...
如果当前库/账号支持按钮图标，会显示动态 emoji 图标；现在只要使用动态 emoji 按钮语法，即使你不写样式，也会默认按 `primary` 尝试显示颜色。如果你还加了按钮样式，也会尝试显示对应颜色：
